...
// $config['base_url'] = 'https://schoolmgmt.brillsense.com/';
// $config['base_url'] = getenv('base_url');
// $config['base_url'] = "http://" . $_SERVER['HTTP_HOST'] . "/";
// $co  nfig['base_url'] = ((array_key_exists('HTTPS', $_SERVER) && $_SERVER['HTTPS'] === 'on') ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . "/";
...
*/
// $config['log_path'] = '';
$config['log_path'] = APPPATH . 'logs/'; // Logs directory within application folder
